    ...
    return Scaffold(
      body: Center(
        child: Padding(
          ...
          child: Column(
            children: [
              Text("Documentos", style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 3, 55, 226), fontSize: 16)),
              ...
              Row(
                children: [
                  ElevatedButton.icon(
                    icon: const Icon(EvaIcons.fileAdd, color: Color.fromARGB(255, 34, 37, 199)),
                  ...
                  SizedBox(width: 5),
                  ElevatedButton.icon(
                    icon: const Icon(EvaIcons.upload, color: Color.fromARGB(255, 34, 37, 199)),
                    onPressed: () {
                      // Define the action to be performed on button press
                      print('Carregar ficheiro pressed');
                    },
