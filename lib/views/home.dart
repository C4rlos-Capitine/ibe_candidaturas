...
class _MyHomePageState extends State<MyHomePage> {
  ...
  return MaterialApp(
          ...
          home: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: Text("IBE - Portal Candidatos", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ...
                bottom: const TabBar(
                    ...
                    tabs: [
                      Tab(icon: Icon(EvaIcons.home), child: Text("Home"),),
                      Tab(icon: Icon(EvaIcons.people), child: Text("Perfil"),),
                      Tab(icon: Icon(EvaIcons.listOutline), child: Text("Bolsas"), ),
